...
public class FeedDAO {
	...
	public static FeedVO equalPost(String u_id, String f_idx) {
		Map<String, String> map = new HashMap<>();
		map.put("u_id", u_id);
		map.put("f_idx", f_idx);
		SqlSession ss = DBService.getFactory().openSession(true);
		FeedVO fvo = ss.selectOne("feed.equalPost",map);
		ss.close();
	...
	// 게시글 삭제
	public static void delPost(String u_id, String f_idx) {
		Map<String, String> map = new HashMap<>();
		map.put("u_id", u_id);
		map.put("f_idx", f_idx);
		SqlSession ss = DBService.getFactory().openSession(true);
		ss.delete("feed.deletePost", map);
		ss.close();
