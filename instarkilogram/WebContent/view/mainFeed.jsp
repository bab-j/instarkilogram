...
<script>
	...
	function goPostPage(){
		document.forms[1].action = "feedcontroller?type=idvPage";
		goWhere();
	}

	
	function goOtherUser() {
		document.forms[1].action = "feedcontroller?type=otherUser";
		goWhere();
	}
	
	function goWhere() {
		let feed_idx = document.getElementById("feed_idx").value;
				...
				<div class="feed_box">
					...
					<div class="feed_name">
						...
						<table>
							<thead class="profile_box">
								<tr>  <!-- 프로필 사진 -->
									...
									<td class="profile_name" onclick="goOtherUser()">${fv.u_id }</td>
						...
						<div class="u_comment">
							...
							<span class="comment_width">${fv.u_id }</span>
							<span class="feed_contain_font">${fv.content }</span>
							</div>
