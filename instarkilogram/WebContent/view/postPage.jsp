...
<body>
	...
	<div class="bar">
		...
		<div class="container">
			<span> <input class="seach1" type="text" placeholder="Search"
				aria-label="Search">&nbsp;
			</span> <span> <input type="button" value="검색"></span>
	...
	<div class="main_body">
		...
		<div class="left_body ">
			...
			<div class="feed_img">
				<img class="feed_img" src="c:/upload/temp/${fvo.getF_pic() }">
			</div>
				...
				<div>
					<div class="feed_name">
						<div class="profile_box">
							...
							<span class="profile_name"> ${fvo.getU_id() } </span>
						</div>
					</div>
					...
					<div class="profile_box1">
						...
						<span><input type="text" name="댓글" value="댓글"></span><br>
						<span>&nbsp;&nbsp;&nbsp;frined33 부럽다. &nbsp;&nbsp;&nbsp;</span><br>
						<span>&nbsp;&nbsp;&nbsp;frined33 부럽다. &nbsp;&nbsp;&nbsp;</span><br>
						<span>&nbsp;&nbsp;&nbsp;frined33 부럽다. &nbsp;&nbsp;&nbsp;</span><br>
					</div>
				</div>
