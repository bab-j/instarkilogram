		...
		<div class="left_body ">
			...
			<div class="feed_box">
				...
				<div class="comment_write">
					...
					<span>
						<form action="commentcontroller?type=commentCommand" method="post">
							<input class="comment_textbox" type="text" name="comment" placeholder="댓글" style="width: 80%;">&nbsp;
							<input type="hidden" name="f_idx" value="">
							<input style="height: 38px;" type="submit" value="추가">
						</form>
					</span>
					<div>&nbsp;</div>
				</div>
