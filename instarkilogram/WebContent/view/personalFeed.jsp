...
<body>
	...
	<br>
	<div class="profile" style="width: 100%; margin-bottom: 100px; margin-top: 50px;">
		<div style="float: left; margin-left: 60px;"><img class="bigProfile_img"
		...
		<div  style="margin-top: 30px; margin-right: 500px;">
			...
			<div style="float: right; width: 150px; text-align: center; margin-bottom: 50px;">
				100<br>
				팔로워
			</div>
		</div>
